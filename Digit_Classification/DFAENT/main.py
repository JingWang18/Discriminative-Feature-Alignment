...
# Training settings
parser = argparse.ArgumentParser(description='PyTorch DFAENT Implementation')
...
parser.add_argument('--lr', type=float, default=0.02, metavar='LR',
                    help='learning rate (svhn 0.1 default: 0.02)')
parser.add_argument('--max_epoch', type=int, default=400, metavar='N',
                    help='how many epochs (svhn 200 others 400)')
