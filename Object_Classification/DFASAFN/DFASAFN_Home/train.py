...
parser.add_argument("--source", default='RealWorld')
...
for epoch in range(1, args.epoch+1):
    ...
    for i, (t_imgs, _) in tqdm.tqdm(enumerate(target_loader_iter)):
        ...
        loss = s_cls_loss + s_fc2_L2norm_loss + t_fc2_L2norm_loss + t_entropy_loss + args.alpha * loss_kld_s + args.beta * loss_dal
        loss.backward()
